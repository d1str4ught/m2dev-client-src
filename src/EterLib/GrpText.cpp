...
CGraphicText::CGraphicText(const char *c_szFileName)
...
void CGraphicText::OnClear() { m_fontTexture.Destroy(); }

bool CGraphicText::OnIsEmpty() const { return m_fontTexture.IsEmpty(); }
