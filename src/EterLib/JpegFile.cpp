...
//   dmgr->free_in_buffer = 0;
// }
// int jpeg_save(unsigned char*data_d, int width, int height, int quality, const
// char*filename)
//{
...
//   return 1;
// }
// int jpeg_save_to_file(unsigned char*data_d, int width, int height, int
// quality, FILE*_fi)
//{
//   struct jpeg_destination_mgr mgr;
//   struct jpeg_compress_struct cinfo;
...
//   return 1;
// }
// int jpeg_save_to_mem(unsigned char*data_d, int width, int height, int
// quality, unsigned char*_dest, int _destlen)
//{
//   struct jpeg_destination_mgr mgr;
//   struct jpeg_compress_struct cinfo;
//   struct jpeg_error_mgr jerr;
...
//     //printf("term %d\n", size - mgr->bytes_in_buffer);
// }
// int jpeg_load_from_mem(unsigned char*_data, int _size, unsigned char*dest,
