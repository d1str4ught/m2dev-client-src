...
public:
  ...
  void ComputeChallengeResponse(const uint8_t *challenge,
                                uint8_t *out_response);
  bool VerifyChallengeResponse(const uint8_t *challenge,
  ...
  bool EncryptToken(const uint8_t *plaintext, size_t len, uint8_t *ciphertext,
                    uint8_t *nonce_out);
  bool DecryptToken(const uint8_t *ciphertext, size_t len, const uint8_t *nonce,
                    uint8_t *plaintext);
