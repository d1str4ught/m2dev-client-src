...
PyObject *grpSetPositionCamera(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().SetPositionCamera(fx, fy, fz, distance, pitch,
                                               roll);
  return Py_BuildNone();
}
...
PyObject *grpSetEyeCamera(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().SetEyeCamera(xEye, yEye, zEye, xCenter, yCenter,
                                          zCenter, xUp, yUp, zUp);
  return Py_BuildNone();
}
...
PyObject *grpGenerateColor(PyObject *poSelf, PyObject *poArgs) {
  ...
  return Py_BuildValue("l",
                       CPythonGraphic::Instance().GenerateColor(r, g, b, a));
}
...
PyObject *grpRenderLine(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderLine2d((float)x, (float)y, (float)x + width,
                                          (float)y + height);
  return Py_BuildNone();
}
...
PyObject *grpRenderRoundBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderLine2d(fx + 2.0f, fy,
                                          fx + 2.0f + (fWidth - 3.0f), fy);
  CPythonGraphic::Instance().RenderLine2d(
      fx + 2.0f, fy + fHeight, fx + 2.0f + (fWidth - 3.0f), fy + fHeight);
  CPythonGraphic::Instance().RenderLine2d(fx, fy + 2.0f, fx,
                                          fy + 2.0f + fHeight - 4.0f);
  CPythonGraphic::Instance().RenderLine2d(fx + fWidth, fy + 1.0f, fx + fWidth,
                                          fy + 1.0f + fHeight - 3.0f);
  CPythonGraphic::Instance().RenderLine2d(fx, fy + 2.0f, fx + 2.0f, fy);
  CPythonGraphic::Instance().RenderLine2d(fx, fy + fHeight - 2.0f, fx + 2.0f,
                                          fy + fHeight);
  CPythonGraphic::Instance().RenderLine2d(fx + fWidth - 2.0f, fy, fx + fWidth,
                                          fy + 2.0f);
  CPythonGraphic::Instance().RenderLine2d(fx + fWidth - 2.0f, fy + fHeight,
                                          fx + fWidth, fy + fHeight - 2.0f);
  return Py_BuildNone();
}
...
PyObject *grpRenderBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderBox2d((float)x, (float)y, (float)x + width,
                                         (float)y + height);
  return Py_BuildNone();
}
...
PyObject *grpRenderBar(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderBar2d((float)x, (float)y, (float)x + width,
                                         (float)y + height);
  return Py_BuildNone();
}
...
PyObject *grpRenderGradationBar(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderGradationBar2d(
      (float)x, (float)y, (float)x + width, (float)y + height, iStartColor,
      iEndColor);
  return Py_BuildNone();
}
...
PyObject *grpRenderDownButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderDownButton(
...
PyObject *grpRenderUpButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderUpButton(
      (float)x, (float)y, (float)x + width, (float)y + height);
  return Py_BuildNone();
}
...
PyObject *grpRenderBox3d(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().RenderBox3d((float)sx, (float)sy, (float)sz,
...
PyObject *grpSaveScreenShotToPath(PyObject *poSelf, PyObject *poArgs) {
  ...
  snprintf(szPath, sizeof(szPath), "%s%02d%02d_%02d%02d%02d.jpg", szBasePath,
...
PyObject *grpSaveScreenShot(PyObject *poSelf, PyObject *poArgs) {
  ...
  wchar_t wFile[64]{};
  swprintf_s(wFile, L"%02d%02d_%02d%02d%02d.jpg", tmNow.tm_mon + 1,
  ...
  BOOL bResult =
      CPythonGraphic::Instance().SaveScreenShot(WideToUtf8(wPath).c_str());
...
PyObject *grpSetViewport(PyObject *poSelf, PyObject *poArgs) {
  ...
  CPythonGraphic::Instance().SetViewport(fx * uWidth, fy * uHeight,
                                         fWidth * uWidth, fHeight * uHeight);
  return Py_BuildNone();
}
