...
PyObject *wndMgrOnceIgnoreMouseLeftButtonUpEvent(PyObject *poSelf,
                                                 PyObject *poArgs) {
...
PyObject *wndMgrRegisterSlotWindow(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterSlotWindow(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterGridSlotWindow(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterGridSlotWindow(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterTextLine(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterTextLine(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterMarkBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterMarkBox(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterImageBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterImageBox(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterExpandedImageBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterExpandedImageBox(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterAniImageBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterAniImageBox(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterButton(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterRadioButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterRadioButton(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterToggleButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterToggleButton(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterDragButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterDragButton(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterBox(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterBox(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterBar(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterBar(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterLine(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterLine(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterBar3D(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterBar3D(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
...
PyObject *wndMgrRegisterNumberLine(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindow *pWindow =
      UI::CWindowManager::Instance().RegisterNumberLine(po, szLayer);
  return Py_BuildValue("K", pWindow);
}
///// Register /////
/////////////////////////////////////////////////////////////////////////////////////////////////
...
PyObject *wndMgrIsFocus(PyObject *poSelf, PyObject *poArgs) {
  ...
  return Py_BuildValue(
      "K", pWindow == UI::CWindowManager::Instance().GetActivateWindow());
}
...
PyObject *wndMgrGetWindowRect(PyObject *poSelf, PyObject *poArgs) {
  ...
  return Py_BuildValue("iiii", rRect.left, rRect.top, rRect.right - rRect.left,
...
PyObject *wndMgrIsIn(PyObject *poSelf, PyObject *poArgs) {
  ...
  return Py_BuildValue("i",
                       pWin == UI::CWindowManager::Instance().GetPointWindow());
}
...
PyObject *wndMgrGetHyperlink(PyObject *poSelf, PyObject *poArgs) {
  char retBuf[1024];
  int retLen =
      CGraphicTextInstance::Hyperlink_GetText(retBuf, sizeof(retBuf) - 1);
  retBuf[retLen] = '\0';
...
PyObject *wndMgrArrangeSlot(PyObject *poSelf, PyObject *poArgs) {
  ...
  pGridSlotWin->ArrangeGridSlot(iStartIndex, ixCellCount, iyCellCount,
                                ixCellSize, iyCellSize, ixBlank, iyBlank);
...
PyObject *wndMgrSetCoverButton(PyObject *poSelf, PyObject *poArgs) {
  ...
  pSlotWin->SetCoverButton(iSlotIndex, szUpImageName, szOverImageName,
                           szDownImageName, szDisableImageName,
                           iLeftButtonEnable, iRightButtonEnable);
...
PyObject *wndMgrSetSlot(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CSlotWindow *pSlotWin = (UI::CSlotWindow *)pWin;
  pSlotWin->SetSlot(iSlotIndex, iItemIndex, iWidth, iHeight,
                    (CGraphicImage *)iImageHandle, diffuseColor);
...
PyObject *wndMgrAttachIcon(PyObject *poSelf, PyObject *poArgs) {
  ...
  UI::CWindowManager::Instance().AttachIcon(iType, iIndex, iSlotNumber, iWidth,
                                            iHeight);
  return Py_BuildNone();
}
...
PyObject *wndTextSetFontColor(PyObject *poSelf, PyObject *poArgs) {
  ...
  if (2 == PyTuple_Size(poArgs)) {
    ...
    BYTE argb[4] = {(BYTE)(255.0f * fb), (BYTE)(255.0f * fg),
                    (BYTE)(255.0f * fr), (BYTE)(255.0f * fa)};
...
PyObject *wndNumberSetNumberHorizontalAlignCenter(PyObject *poSelf,
                                                  PyObject *poArgs) {
  UI::CWindow *pWindow;
  if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
    return Py_BuildException();

  ((UI::CNumberLine *)pWindow)
      ->SetHorizontalAlign(UI::CWindow::HORIZONTAL_ALIGN_CENTER);

  return Py_BuildNone();
}

PyObject *wndNumberSetNumberHorizontalAlignRight(PyObject *poSelf,
                                                 PyObject *poArgs) {
  UI::CWindow *pWindow;
  if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
    return Py_BuildException();
  ...
  ((UI::CNumberLine *)pWindow)
      ->SetHorizontalAlign(UI::CWindow::HORIZONTAL_ALIGN_RIGHT);
...
PyObject *wndImageLoadImageFromFile(PyObject *poSelf, PyObject *poArgs) {
  ...
  if (!((UI::CImageBox *)pWindow)->LoadImageFromFile(szFileName))
    return Py_BuildException("Failed to load image from file (filename: %s)",
                             szFileName);
...
PyObject *wndButtonSetRestrictMovementArea(PyObject *poSelf, PyObject *poArgs) {
  ...
  ((UI::CDragButton *)pWindow)
      ->SetRestrictMovementArea(ix, iy, iwidth, iheight);
...
void initwndMgr() {
  static PyMethodDef s_methods[] = {
      ...
      {"OnceIgnoreMouseLeftButtonUpEvent",
       wndMgrOnceIgnoreMouseLeftButtonUpEvent, METH_VARARGS},
      ...
      {"RegisterExpandedImageBox", wndMgrRegisterExpandedImageBox,
       METH_VARARGS},
      ...
      {"SetWindowHorizontalAlign", wndMgrSetWindowHorizontalAlign,
       METH_VARARGS},
      ...
      {"SetAlwaysRenderCoverButton", wndMgrSetAlwaysRenderCoverButton,
       METH_VARARGS},

      {"AppendSlotButton", wndMgrAppendSlotButton, METH_VARARGS},
      {"AppendRequirementSignImage", wndMgrAppendRequirementSignImage,
       METH_VARARGS},
      ...
      {"SetNumberHorizontalAlignCenter",
       wndNumberSetNumberHorizontalAlignCenter, METH_VARARGS},
      {"SetNumberHorizontalAlignRight", wndNumberSetNumberHorizontalAlignRight,
       METH_VARARGS},
      ...
      // DragButton
      {"SetRestrictMovementArea", wndButtonSetRestrictMovementArea,
       METH_VARARGS},
  ...
  // 하나의 딕셔너리에 너무 많은 Function이 포함 되는 것 같아 이런식으로
  // 딕셔너리를 나누는 것을 고려 중 - [levites]
  ...
  PyModule_AddIntConstant(poModule, "SLOT_STYLE_PICK_UP",
                          UI::SLOT_STYLE_PICK_UP);
  PyModule_AddIntConstant(poModule, "SLOT_STYLE_SELECT", UI::SLOT_STYLE_SELECT);

  PyModule_AddIntConstant(poModule, "TEXT_HORIZONTAL_ALIGN_LEFT",
                          CGraphicTextInstance::HORIZONTAL_ALIGN_LEFT);
  PyModule_AddIntConstant(poModule, "TEXT_HORIZONTAL_ALIGN_RIGHT",
                          CGraphicTextInstance::HORIZONTAL_ALIGN_RIGHT);
  PyModule_AddIntConstant(poModule, "TEXT_HORIZONTAL_ALIGN_CENTER",
                          CGraphicTextInstance::HORIZONTAL_ALIGN_CENTER);
  PyModule_AddIntConstant(poModule, "TEXT_VERTICAL_ALIGN_TOP",
                          CGraphicTextInstance::VERTICAL_ALIGN_TOP);
  PyModule_AddIntConstant(poModule, "TEXT_VERTICAL_ALIGN_BOTTOM",
                          CGraphicTextInstance::VERTICAL_ALIGN_BOTTOM);
  PyModule_AddIntConstant(poModule, "TEXT_VERTICAL_ALIGN_CENTER",
                          CGraphicTextInstance::VERTICAL_ALIGN_CENTER);
  ...
  PyModule_AddIntConstant(poModule, "HORIZONTAL_ALIGN_LEFT",
                          UI::CWindow::HORIZONTAL_ALIGN_LEFT);
  PyModule_AddIntConstant(poModule, "HORIZONTAL_ALIGN_CENTER",
                          UI::CWindow::HORIZONTAL_ALIGN_CENTER);
  PyModule_AddIntConstant(poModule, "HORIZONTAL_ALIGN_RIGHT",
                          UI::CWindow::HORIZONTAL_ALIGN_RIGHT);
  PyModule_AddIntConstant(poModule, "VERTICAL_ALIGN_TOP",
                          UI::CWindow::VERTICAL_ALIGN_TOP);
  PyModule_AddIntConstant(poModule, "VERTICAL_ALIGN_CENTER",
                          UI::CWindow::VERTICAL_ALIGN_CENTER);
  PyModule_AddIntConstant(poModule, "VERTICAL_ALIGN_BOTTOM",
                          UI::CWindow::VERTICAL_ALIGN_BOTTOM);

  PyModule_AddIntConstant(
      poModule, "RENDERING_MODE_MODULATE",
