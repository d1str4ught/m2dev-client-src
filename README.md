...
#### Real-time target tracking for skill splash attacks:

Skills like Shooting Dragon now track moving entity targets in real-time and the damage follows them correctly if the target has moved after the skill cast.
